...
\addvspace {10\p@ }
\addvspace {10\p@ }
\contentsline {lstlisting}{\numberline {4.1}Generierung von Kindprozessen in master.js}{16}{lstlisting.4.1}
\contentsline {lstlisting}{\numberline {4.2}Schreiben in die mongoDB in aisData-client.js}{16}{lstlisting.4.2}
\contentsline {lstlisting}{\numberline {4.3}Aufbau des Geo-Indexes in aisData-client.js}{17}{lstlisting.4.3}
\contentsline {lstlisting}{\numberline {4.4}Vessel-in-Bounds-query in worker.js}{17}{lstlisting.4.4}
\contentsline {lstlisting}{\numberline {4.5}Speichern der \IeC {\"u}bermittelten Client-Daten in worker.js}{18}{lstlisting.4.5}
\contentsline {lstlisting}{\numberline {4.6}Weiterleitung von Positions-Updates an Websocket-Clients in worker.js}{18}{lstlisting.4.6}
...
\contentsline {lstlisting}{\numberline {5.2}LeafletMap.dart mit urspr\IeC {\"u}nglicher Abfrage des Bounds-Objektes}{33}{lstlisting.5.2}
\contentsline {lstlisting}{\numberline {5.3}LeafletMap.dart mit workaround \IeC {\"u}ber BBoxString}{34}{lstlisting.5.3}
\addvspace {10\p@ }
