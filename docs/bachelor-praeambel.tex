...
%headinclude,
 twoside=false, parskip=half+, pagesize=auto, numbers=noenddot, plainheadsepline, open=right, toc=listof, toc=bibliography]{scrreprt}
% PDF-Kompression
\pdfminorversion=5
...
\usepackage{geometry}
\geometry{a4paper,left=40mm,right=30mm, top=1cm, bottom=1cm} 
% Schriften
