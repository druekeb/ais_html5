...
% headinclude,
 twoside=false, parskip=half+, numbers=noenddot, plainheadsepline, toc=listof, toc=bibliography]{scrreprt}
% PDF-Kompression
\pdfminorversion=5
...
\usepackage[paper=a4paper, tmargin=522pt,lmargin=74pt,
headheight=30pt,marginparwidth=62pt,
includehead,includemp]{geometry}
%\geometry{a4paper,left=60mm,right=30mm, top=2cm, bottom=1cm} 
% Schriften
