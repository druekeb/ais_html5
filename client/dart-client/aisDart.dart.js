...
$$.initWebSocket_anon = {"": "Closure;",
  call$1: function(e) {
    $.get$console$x(window).log$1("Connected to Websocket-Server");
    if ($.leaflet_map == null)
      $.initMap();
  }
};
...
$$.initWebSocket_anon0 = {"": "Closure;retrySeconds_0",
  call$1: function(evt) {
    ...
    if ($.encounteredError !== true)
      $.Timer_Timer($.Duration$(0, 0, 0, 0, 0, 1), new $.initWebSocket__anon0(t1));
...
$$.initWebSocket_anon1 = {"": "Closure;",
  call$1: function(evt) {
    var timeMessage, timeQuery, json, t1, t2;
    timeMessage = $.DateTime$_now().millisecondsSinceEpoch;
    timeQuery = $.$sub$n(timeMessage, $.timeFlex);
    json = $.parse($.get$data$x(evt), null);
    t1 = $.getInterceptor$asx(json);
    if ($.$eq(t1.$index(json, "type"), "vesselsInBoundsEvent") === true) {
      t2 = "BoundsEvent: " + $.S($.leaflet_map.getZoom$0()) + " " + $.S($.get$length$asx(t1.$index(json, "vessels"))) + " " + $.S(timeQuery);
      $.get$console$x(window).log$1(t2);
      $.processVesselsInBounds(t1.$index(json, "vessels"), timeMessage);
    }
...
$$.initWebSocket_anon2 = {"": "Closure;retrySeconds_2",
  call$1: function(evt) {
    var t1 = "Error connecting to ws " + $.S($.toString$0(evt));
    $.get$console$x(window).log$1(t1);
    if ($.encounteredError !== true)
      $.Timer_Timer($.Duration$(0, 0, 0, 0, 0, 1), new $.initWebSocket__anon(this.retrySeconds_2));
    $.encounteredError = true;
  }
};
...
$$.initWebSocket__anon = {"": "Closure;retrySeconds_3",
  call$0: function() {
    return $.initWebSocket(this.retrySeconds_3);
  }
};

$$.processVesselsInBounds_anon = {"": "Closure;",
  call$2: function(k, v) {
    var t1 = $.getInterceptor$asx(v);
...
$$.processVesselsInBounds_anon0 = {"": "Closure;currentZoom_0,x_1",
  call$1: function(vesselWithMapObjects) {
    var t1;
    $.DateTime$_now();
    $.$indexSet$ax($.get$vessels(), $.S($.$index$asx(this.x_1, "mmsi")), vesselWithMapObjects);
    if ($.$gt$n(this.currentZoom_0, 12) === true) {
      t1 = $.getInterceptor$asx(vesselWithMapObjects);
...
$$.processVesselPositionEvent_anon = {"": "Closure;json_0",
  call$1: function(vesselWithMapObjects) {
    var t1;
    $.$indexSet$ax($.get$vessels(), $.toString$0($.$index$asx(this.json_0, "userid")), vesselWithMapObjects);
    if ($.$gt$n($.leaflet_map.getZoom$0(), 12) === true) {
      t1 = $.getInterceptor$x(vesselWithMapObjects);
      if (t1.containsKey$1(vesselWithMapObjects, "triangle") === true)
        t1.$index(vesselWithMapObjects, "triangle").startAnimation$0();
      if (t1.containsKey$1(vesselWithMapObjects, "polygon") === true)
        t1.$index(vesselWithMapObjects, "polygon").startAnimation$0();
    }
    $.DateTime$_now();
  }
...
$$.LeafletMap = {"": "Object;_elementid<,_map@,_featureLayerGroup@,_popup@,_zoom?",
...
$$.OpenStreetMap = {"": "LeafletMap;initialZoom<,initialLat<,initialLon<,boundsTimeout,_elementid,_width,_height,_map,_featureLayerGroup,_popup,_zoom",
  loadMap$0: function() {
  ...
  changeRegistration$0: function() {
    ...
    if (typeof zoom !== "number")
      return this.changeRegistration$0$bailout(1, zoom);
    if (zoom < 3) {
      this.setZoom$1(3);
      return;
    }
    boundsArray = $.split$1$s(this.getBounds$0(), ",");
    if (0 >= boundsArray.length)
      throw $.ioore(0);
    t1 = $.double_parse(boundsArray[0], null);
    if (1 >= boundsArray.length)
      throw $.ioore(1);
    ...
    this.boundsTimeout = $.Timer_Timer($.Duration$(0, 0, 0, 120000, 0, 0), this.get$changeRegistration());
  },
  changeRegistration$0$bailout: function(state0, zoom) {
    var boundsArray, t1, _southWest, t2, bounds, message;
    if ($.$lt$n(zoom, 3) === true) {
      this.setZoom$1(3);
      return;
    }
  ...
  get$changeRegistration: function() {
    return new $.BoundClosure$0(this, "changeRegistration$0");
  },
  ...
  setZoom$1: function(zoom) {
    $.scoped(new $.OpenStreetMap_setZoom_anon(this, zoom));
  },
  ...
  OpenStreetMap$4$height$width: function(elementid, mapOptions, height, width) {
    var t1 = $.getInterceptor$asx(mapOptions);
    this.initialZoom = t1.$index(mapOptions, 1);
    this.initialLat = $.get$latitude$x(t1.$index(mapOptions, 0));
    this.initialLon = $.get$longitude$x(t1.$index(mapOptions, 0));
  }
};
...
$$.OpenStreetMap_getBounds_anon = {"": "Closure;box_0,this_1",
  call$0: function() {
    var bBox = this.this_1.get$_map().getBounds$0().toBBoxString$0();
...
$$.OpenStreetMap_getZoom_anon = {"": "Closure;this_0",
  call$0: function() {
    var t1 = this.this_0;
    t1.set$_zoom(t1.get$_map().getZoom$0());
  }
};

$$.OpenStreetMap_setZoom_anon = {"": "Closure;this_0,zoom_1",
  call$0: function() {
    this.this_0.get$_map().setZoom$1(this.zoom_1);
  }
};
...
$$.OpenStreetMap_closePopup_anon = {"": "Closure;this_0",
  call$0: function() {
    $.closePopup$0$x(this.this_0.get$_map());
  }
};
...
$$.Popup = {"": "Object;_popup@",
  ...
  Popup$3: function(popupOrigin, $content, options) {
    $.scoped(new $.anon5(this, popupOrigin, $content, options));
  }
};

$$.anon5 = {"": "Closure;this_0,popupOrigin_1,content_2,options_3",
  call$0: function() {
    var popupOptions, t1, offsetPoint, latlng, t2, t3, origin, t4;
    popupOptions = this.options_3;
    t1 = $.getInterceptor$asx(popupOptions);
    offsetPoint = $.Proxy_Proxy($.context().get$L().get$Point(), $.$index$asx(t1.$index(popupOptions, "offset"), 0), $.$index$asx(t1.$index(popupOptions, "offset"), 1), $, $);
    latlng = $.context().get$L().get$LatLng();
    t2 = this.popupOrigin_1;
    t3 = $.getInterceptor$x(t2);
    origin = $.Proxy_Proxy(latlng, t3.get$latitude(t2), t3.get$longitude(t2), $, $);
    ...
    t4 = this.this_0;
    t4.set$_popup(t1);
    t4.get$_popup().setLatLng$1(origin);
    t4.get$_popup().setContent$1(this.content_2);
    t4 = t4.get$_popup();
    $._jsGlobalize.callSync$1($._serialize(t4.toJs$0()));
  }
};
...
$$.MapFeature = {"": "Object;_mapFeature@",
  addListeners$1: function(mmsi) {
    ...
    $.on$2$x(this._mapFeature, "click", $.Callback$many(t1));
    $.on$2$x(this._mapFeature, "mouseover", $.Callback$many(t3));
    $.on$2$x(this._mapFeature, "mouseout", $.Callback$many(t2));
  },
  addTo$2: function(map, featureLayer) {
    $.scoped(new $.MapFeature_addTo_anon(this, map, featureLayer));
  },
  remove$2: function(_, map, featureLayer) {
...
$$.MapFeature_addListeners_onClickHandler = {"": "Closure;mmsi_0",
  call$1: function(e) {
    var t1 = this.mmsi_0;
    $.Primitives_printString("clickEvent on " + $.S($.get$type$x(e)) + " for ship " + $.S(t1));
    return;
  }
};
...
$$.MapFeature_addTo_anon = {"": "Closure;this_0,map_1,featureLayer_2",
  call$0: function() {
    ...
    if (t1 === true)
      ...
      t3.get$_mapFeature().addTo$1(t2.get$_map());
  }
};
...
$$.MapFeature_remove_anon = {"": "Closure;this_0,map_1,featureLayer_2",
  call$0: function() {
    ...
    if (t1 === true)
      ...
      $.remove$1$ax(t2.get$_map(), t3.get$_mapFeature());
  }
};
...
$$.anon4 = {"": "Closure;this_0,vectorPoints_1,options_2",
  call$0: function() {
    var latlng, points, t1, x, lat, lineOptions, t2;
    latlng = $.context().get$L().get$LatLng();
    ...
    if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
      return this.call$0$bailout(1, t1, points, latlng);
    x = 0;
    for (; x < t1.length; ++x) {
      lat = $.get$latitude$x(t1[x]);
      if (x >= t1.length)
        throw $.ioore(x);
      points.push$1($.Proxy_Proxy(latlng, lat, $.get$longitude$x(t1[x]), $, $));
    }
  ...
  call$0$bailout: function(state0, t1, points, latlng) {
    var t3, x, lineOptions, t2;
    t3 = $.getInterceptor$asx(t1);
    x = 0;
    for (; $.JSNumber_methods.$lt(x, $.get$length$asx(t1)); ++x)
      points.push$1($.Proxy_Proxy(latlng, $.get$latitude$x(t3.$index(t1, x)), $.get$longitude$x(t3.$index(t1, x)), $, $));
    lineOptions = $.Proxy_Proxy$_json(this.options_2);
    t1 = $.Proxy_Proxy($.context().get$L().get$Polyline(), points, lineOptions, $, $);
    t2 = this.this_0;
    t2.set$_mapFeature(t1);
...
$$.AnimatedPolygon = {"": "MapFeature;_mapFeature",
  ...
  AnimatedPolygon$3: function(vectorPoints, options, vmmsi) {
    $.scoped(new $.anon3(this, vectorPoints, options, vmmsi));
  }
};

$$.anon3 = {"": "Closure;this_0,vectorPoints_1,options_2,vmmsi_3",
  call$0: function() {
    var latlng, points, t1, x, lat, triangleOptions, t2;
    latlng = $.context().get$L().get$LatLng();
    points = $.Proxy_Proxy$_json([]);
    t1 = this.vectorPoints_1;
    if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
...
$$.AnimatedPolygon_startAnimation_anon = {"": "Closure;this_0",
  call$0: function() {
    $.start$0$x(this.this_0.get$_mapFeature());
  }
};

$$.AnimatedPolygon_stopAnimation_anon = {"": "Closure;this_0",
  call$0: function() {
    $.stop$0$x(this.this_0.get$_mapFeature());
  }
};
...
$$.Marker_setIcon_anon = {"": "Closure;this_0,icon_1",
  call$0: function() {
    ...
    t2 = this.icon_1;
    size = $.Proxy_Proxy(t1, $.get$width$x(t2.get$dimension()), $.get$height$x(t2.get$dimension()), $, $);
...
$$.ListQueue = {"": "Collection;_table<,_head,_tail,_modificationCount<",
  ...
  _remove$1: function(_, offset) {
    ...
    if (startDistance < (t4 - offset & mask) >>> 0) {
      ...
      while (true) {
        if (t3 !== (t3 | 0))
          return this._remove$1$bailout(3, offset, t1, mask, 0, t3, t2, i);
        if (!(i !== t3))
          break;
  ...
  _remove$1$bailout: function(state0, offset, t1, mask, startDistance, t3, t2, i) {
    switch (state0) {
      case 0:
...
$$.Object = {"": ";",
  ...
  $$dom_removeAttribute$1: function($receiver, $0) {
  ...
  closePopup$0: function($receiver) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("closePopup", "closePopup$0", 0, [], []));
  },
  ...
  get$onClose: function($receiver) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("onClose", "get$onClose", 1, [], []));
  },
  get$onError: function($receiver) {
  ...
  get$onOpen: function($receiver) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("onOpen", "get$onOpen", 1, [], []));
  },
  ...
  getBounds$0: function() {
    return this.noSuchMethod$1(this, $.createInvocationMirror("getBounds", "getBounds$0", 0, [], []));
  },
  getZoom$0: function() {
    return this.noSuchMethod$1(this, $.createInvocationMirror("getZoom", "getZoom$0", 0, [], []));
  },
  ...
  setLatLng$1: function($0) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("setLatLng", "setLatLng$1", 0, [$0], []));
  },
  setView$2: function($0, $1) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("setView", "setView$2", 0, [$0, $1], []));
  },
  ...
  startAnimation$0: function() {
    return this.noSuchMethod$1(this, $.createInvocationMirror("startAnimation", "startAnimation$0", 0, [], []));
  },
  ...
  stopAnimation$0: function() {
    return this.noSuchMethod$1(this, $.createInvocationMirror("stopAnimation", "stopAnimation$0", 0, [], []));
  },
...
$$._Deserializer0 = {"": "Object;",
  deserialize$1: function(x) {
    if (x == null || typeof x === "string" || typeof x === "number" || typeof x === "boolean")
      return x;
    this._liblib3$_deserialized = $.HashMap$(null, null);
  ...
  _liblib3$_deserializeMap$1: function(x) {
    ...
    keys = t1.$index(x, 2);
    if (typeof keys !== "string" && (typeof keys !== "object" || keys === null || keys.constructor !== Array && !keys.$isJavaScriptIndexingBehavior()))
      return this._liblib3$_deserializeMap$1$bailout(1, keys, t1, x, result);
    values = t1.$index(x, 3);
    if (typeof values !== "string" && (typeof values !== "object" || values === null || values.constructor !== Array && !values.$isJavaScriptIndexingBehavior()))
      return this._liblib3$_deserializeMap$1$bailout(2, keys, 0, 0, result, values);
    len = keys.length;
    for (i = 0; i < len; ++i) {
      if (i >= keys.length)
        throw $.ioore(i);
  ...
  _liblib3$_deserializeMap$1$bailout: function(state0, keys, t1, x, result, values) {
    switch (state0) {
      case 0:
        result = $.HashMap$(null, null);
        t1 = $.getInterceptor$asx(x);
...
$$.Callback = {"": "Object;_manualDispose,_liblib2$_id,_liblib2$_callback",
  ...
  Callback$many$1: function(f) {
    this._liblib2$_callback = new $.anon2(f);
...
$.initMap = function() {
  ...
  height = $.toString$0($.get$innerHeight$x(window));
  width = $.toString$0($.get$innerWidth$x(window));
  height0 = $.S(height) + " px";
  width0 = $.S(width) + " px";
...
$.initWebSocket = function(retrySeconds) {
  ...
  $.get$onError$x($.socket).listen$1(new $.initWebSocket_anon2(retrySeconds));
};

$.processVesselsInBounds = function(jsonArray, timeMessage) {
  var currentZoom, t1, t2;
  currentZoom = $.leaflet_map.getZoom$0();
  if (typeof currentZoom !== "number")
    return $.processVesselsInBounds$bailout(1, jsonArray, timeMessage, currentZoom);
  ...
  if (currentZoom < 13) {
    ...
    $.set$text$x($.query$1$x(document, "#zoomSpeed"), t1);
    $.set$display$x($.get$style$x($.query$1$x(document, "#zoomSpeed")), "block");
  } else
    $.set$display$x($.get$style$x($.query$1$x(document, "#zoomSpeed")), "none");
  t1 = $.DateTime$_now();
...
$.processVesselPositionEvent = function(json) {
  ...
  $.DateTime$_now();
  t1 = $.getInterceptor$asx(json);
  vessel = $.$index$asx($.get$vessels(), $.toString$0(t1.$index(json, "userid")));
  if (vessel == null) {
    vessel = $.makeLiteralMap([]);
    vessel.$indexSet(vessel, "mmsi", t1.$index(json, "userid"));
  }
  t2 = $.getInterceptor$ax(vessel);
  ...
  if (t2.$index(vessel, "vector") != null) {
    $.remove$2$ax(t2.$index(vessel, "vector"), $.leaflet_map, true);
    t2.remove$1(vessel, "vector");
  }
  if (t2.$index(vessel, "polygon") != null) {
    t2.$index(vessel, "polygon").stopAnimation$0();
    $.remove$2$ax(t2.$index(vessel, "polygon"), $.leaflet_map, true);
    t2.remove$1(vessel, "polygon");
  }
  if (t2.$index(vessel, "triangle") != null) {
    t2.$index(vessel, "triangle").stopAnimation$0();
    $.remove$2$ax(t2.$index(vessel, "triangle"), $.leaflet_map, true);
    t2.remove$1(vessel, "triangle");
  }
  $.paintToMap(vessel, $.leaflet_map.getZoom$0(), new $.processVesselPositionEvent_anon(json));
};

$.onMouseoverHandler = function(e, mmsi) {
  var vessel, pos, t1, latlong, popupOptions;
  vessel = $.$index$asx($.get$vessels(), $.S(mmsi));
  pos = $.$index$asx(vessel, "pos");
  t1 = $.getInterceptor$asx(pos);
  latlong = $.Coord$(t1.$index(pos, 1), t1.$index(pos, 0));
  popupOptions = $.makeLiteralMap(["closeButton", false, "autoPan", false, "offset", [50, -50]]);
  $.Popup$(latlong, $.createMouseOverPopup(vessel), popupOptions).addTo$1($.leaflet_map);
};

$.paintToMap = function(v, zoom, callback) {
  var t1, moving, t2, shipStatics, vectorPoints, vectorLength, vectorWidth, animationPartsSize, circleOptions, iconOptions, icon;
  t1 = $.getInterceptor$asx(v);
  if (t1.$index(v, "pos") != null) {
    $.DateTime$_now();
    if ($.$lt$n(t1.$index(v, "msgid"), 4) === true || $.$eq(t1.$index(v, "msgid"), 5) === true) {
      moving = t1.$index(v, "sog") != null && $.$gt$n(t1.$index(v, "sog"), 0.4) === true && $.$eq(t1.$index(v, "sog"), 102.3) !== true;
      if ($.$gt$n($.leaflet_map.getZoom$0(), 11) === true) {
        ...
        shipStatics = false;
      t1.$indexSet(v, "brng", $.calcAngle(v));
      Math.cos($.checkNum(t1.$index(v, "brng")));
      Math.sin($.checkNum(t1.$index(v, "brng")));
      vectorPoints = $.List_List($, null);
      vectorPoints.push($.Coord$($.$index$asx(t1.$index(v, "pos"), 1), $.$index$asx(t1.$index(v, "pos"), 0)));
      if (moving) {
        vectorLength = $.$mul$n($.$mul$n(t1.$index(v, "sog"), 0.51444), 30);
        vectorPoints.push($.destinationPoint($.$index$asx(t1.$index(v, "pos"), 1), $.$index$asx(t1.$index(v, "pos"), 0), t1.$index(v, "cog"), vectorLength));
        vectorWidth = $.$gt$n(t1.$index(v, "sog"), 30) === true ? 5 : 2;
        ...
        $.DateTime$_now();
        animationPartsSize = $.$div$n(vectorLength, zoom);
        if (shipStatics) {
          t1.$indexSet(v, "polygon", $.AnimatedPolygon$(vectorPoints, $.makeLiteralMap(["autoStart", false, "animation", true, "distance", animationPartsSize, "interval", 2000, "dim_stern", t1.$index(v, "dim_stern"), "dim_port", t1.$index(v, "dim_port"), "dim_bow", t1.$index(v, "dim_bow"), "dim_starboard", t1.$index(v, "dim_starboard"), "brng", t1.$index(v, "brng"), "color", "blue", "weight", 3, "fill", true, "fillColor", $.$index$asx($.get$shipTypeColors(), t1.$index(v, "ship_type")), "fillOpacity", 0.6, "clickable", false]), t1.$index(v, "mmsi")));
          $.DateTime$_now();
          t1.$index(v, "polygon").addTo$2($.leaflet_map, true);
          $.DateTime$_now();
        }
        t1.$indexSet(v, "triangle", $.AnimatedPolygon$(vectorPoints, $.makeLiteralMap(["autoStart", false, "animation", true, "distance", animationPartsSize, "interval", 2000, "brng", t1.$index(v, "brng"), "zoom", $.leaflet_map.getZoom$0(), "color", "black", "weight", 1, "fill", true, "fillColor", $.$index$asx($.get$shipTypeColors(), t1.$index(v, "ship_type")), "fillOpacity", 0.8, "clickable", true]), t1.$index(v, "mmsi")));
        $.DateTime$_now();
        t1.$index(v, "triangle").addTo$2($.leaflet_map, true);
        $.DateTime$_now();
      } else {
        if (shipStatics) {
          t1.$indexSet(v, "polygon", $.AnimatedPolygon$(vectorPoints, $.makeLiteralMap(["autoStart", false, "animation", false, "dim_stern", t1.$index(v, "dim_stern"), "dim_port", t1.$index(v, "dim_port"), "dim_bow", t1.$index(v, "dim_bow"), "dim_starboard", t1.$index(v, "dim_starboard"), "brng", t1.$index(v, "brng"), "color", "blue", "weight", 3, "fill", true, "fillColor", $.$index$asx($.get$shipTypeColors(), t1.$index(v, "ship_type")), "fillOpacity", 0.6, "clickable", false]), t1.$index(v, "mmsi")));
          $.DateTime$_now();
          t1.$index(v, "polygon").addTo$2($.leaflet_map, true);
          $.DateTime$_now();
        }
        circleOptions = $.makeLiteralMap(["radius", 5, "fill", true, "fillColor", $.$index$asx($.get$shipTypeColors(), t1.$index(v, "ship_type")), "fillOpacity", 0.8, "color", "#000000", "opacity", 0.4, "weight", 2.5]);
      ...
      icon = $.Icon$(iconOptions.$index(iconOptions, "iconUrl"), iconOptions.$index(iconOptions, "iconSize"));
      t1.$indexSet(v, "marker", $.Marker$($.$index$asx(t1.$index(v, "pos"), 1), $.$index$asx(t1.$index(v, "pos"), 0), t1.$index(v, "name"), false));
...
$.createMouseOverPopup = function(vessel) {
  ...
  if ($.$eq(t1.$index(vessel, "msgid"), 21) === true) {
    ...
    if (t1.$index(vessel, "aton_type") != null)
      mouseOverPopup = mouseOverPopup + "<tr><td colspan='2'><b>" + $.S($.$index$asx($.get$aton_types(), t1.$index(vessel, "aton_type"))) + "</b></nobr></td></tr>";
  } else if ($.$eq(t1.$index(vessel, "msgid"), 4) === true)
    mouseOverPopup = (t1.$index(vessel, "name") === true ? "<div class='mouseOverPopup'><table><tr><td colspan='2'><b>AIS Base Station</b></nobr></td></tr><tr><td colspan='2'><b>" + $.S(t1.$index(vessel, "name")) + "</b></nobr></td></tr>" : "<div class='mouseOverPopup'><table><tr><td colspan='2'><b>AIS Base Station</b></nobr></td></tr>") + "<tr><td>MMSI: &nbsp;</td><td><nobr>" + $.S($.toString$0(t1.$index(vessel, "mmsi"))) + "</nobr></td></tr>";
  else if ($.$eq(t1.$index(vessel, "msgid"), 9) === true) {
    mouseOverPopup = (t1.$index(vessel, "name") === true ? "<div class='mouseOverPopup'><table><tr><td colspan='2'><b>Helicopter SAR</b></nobr></td></tr><tr><td colspan='2'><b>" + $.S(t1.$index(vessel, "name")) + "</b></nobr></td></tr>" : "<div class='mouseOverPopup'><table><tr><td colspan='2'><b>Helicopter SAR</b></nobr></td></tr>") + "<tr><td>MMSI: &nbsp;</td><td><nobr>" + $.S($.toString$0(t1.$index(vessel, "mmsi"))) + "</nobr></td></tr>";
    if (t1.$index(vessel, "altitude") === true)
      mouseOverPopup = mouseOverPopup + "<tr><td>Altitude: &nbsp;</td><td><nobr>" + $.S($.toString$0(t1.$index(vessel, "altitude"))) + "</nobr></td></tr>";
  } else {
    ...
    mouseOverPopup = (t1.$index(vessel, "imo") != null && $.$eq(t1.$index(vessel, "imo"), "0") !== true ? mouseOverPopup + "<tr><td>IMO</td><td>" + $.S(t1.$index(vessel, "imo")) + "</b></nobr></td></tr>" : mouseOverPopup) + "<tr><td>MMSI: &nbsp;</td><td><nobr>" + $.S($.toString$0(t1.$index(vessel, "mmsi"))) + "</nobr></td></tr>";
    if (t1.$index(vessel, "nav_status") != null && $.$lt$n(t1.$index(vessel, "nav_status"), 15) === true && $.$gt$n(t1.$index(vessel, "nav_status"), -1) === true)
      mouseOverPopup = mouseOverPopup + "<tr><td>NavStatus: &nbsp;</td><td><nobr>" + $.S($.$index$asx($.get$nav_stati(), t1.$index(vessel, "nav_status"))) + "</nobr></td></tr>";
    if (t1.$index(vessel, "sog") != null)
      mouseOverPopup = mouseOverPopup + "<tr><td>Speed: &nbsp;</td><td><nobr>" + $.S($.toString$0(t1.$index(vessel, "sog"))) + "</nobr></td></tr>";
    if (t1.$index(vessel, "true_heading") != null && $.$eq(t1.$index(vessel, "true_heading"), 511) !== true)
      mouseOverPopup = mouseOverPopup + "<tr><td>Heading: &nbsp;</td><td><nobr>" + $.S($.toString$0(t1.$index(vessel, "true_heading"))) + "</nobr></td></tr>";
    ...
    if (t1.$index(vessel, "dim_bow") != null && t1.$index(vessel, "dim_port") != null)
      mouseOverPopup = mouseOverPopup + "<tr><td>length, width</td><td>" + $.S($.toString$0($.$add$ns(t1.$index(vessel, "dim_stern"), t1.$index(vessel, "dim_bow")))) + "," + $.S($.toString$0($.$add$ns(t1.$index(vessel, "dim_starboard"), t1.$index(vessel, "dim_port")))) + "</b></nobr></td></tr>";
    if ($.$index$asx($.get$shipTypes(), t1.$index(vessel, "ship_type")) != null)
      mouseOverPopup = mouseOverPopup + "<tr><td>ship_type</td><td>" + $.S($.$index$asx($.get$shipTypes(), t1.$index(vessel, "ship_type"))) + "</b></nobr></td></tr>";
  }
...
$.calcAngle = function(vessel) {
  ...
  $.$index$asx(t1.$index(vessel, "pos"), 0);
  $.$index$asx(t1.$index(vessel, "pos"), 1);
  sog = t1.$index(vessel, "sog");
  direction = $.$eq(t1.$index(vessel, "mmsi"), 211855000) === true ? 299 : 0;
  if (sog != null && $.$gt$n(sog, 0.4) === true && $.$lt$n(cog, 360) === true)
    direction = cog;
  else {
  ...
  return $.$negate$n(direction) * 0.017453292519943295;
};
...
$.destinationPoint = function(lat, lng, cog, dist) {
  ...
  lat2 = Math.asin($.checkNum(Math.sin($.checkNum(lat1)) * Math.cos($.checkNum(dist)) + Math.cos($.checkNum(lat1)) * Math.sin($.checkNum(dist)) * Math.cos($.checkNum(brng))));
  t1 = Math.sin($.checkNum(brng));
...
$.initTypeArrays = function() {
  $.$indexSet$ax($.get$shipTypes(), 2, "Other Type");
  $.$indexSet$ax($.get$shipTypes(), 6, "Passenger Ships");
  $.$indexSet$ax($.get$shipTypes(), 7, "Cargo Ships");
  $.$indexSet$ax($.get$shipTypes(), 8, "Tankers");
  $.$indexSet$ax($.get$shipTypes(), 9, "Other Type");
  $.$indexSet$ax($.get$shipTypes(), 20, "Wing in ground (WIG)");
  $.$indexSet$ax($.get$shipTypes(), 29, "Wing in ground (WIG)");
  $.$indexSet$ax($.get$shipTypes(), 30, "Fishing");
  $.$indexSet$ax($.get$shipTypes(), 31, "Towing");
  $.$indexSet$ax($.get$shipTypes(), 32, "Towing");
  $.$indexSet$ax($.get$shipTypes(), 33, "Dredger");
  $.$indexSet$ax($.get$shipTypes(), 34, "diving operations");
  $.$indexSet$ax($.get$shipTypes(), 35, "military operations");
  $.$indexSet$ax($.get$shipTypes(), 36, "Sailing");
  $.$indexSet$ax($.get$shipTypes(), 37, "Pleasure craft");
  $.$indexSet$ax($.get$shipTypes(), 38, "Reserved");
  $.$indexSet$ax($.get$shipTypes(), 39, "Reserved");
  $.$indexSet$ax($.get$shipTypes(), 40, "High speed craft");
  $.$indexSet$ax($.get$shipTypes(), 49, "High speed craft");
  $.$indexSet$ax($.get$shipTypes(), 50, "Pilot vessel");
  $.$indexSet$ax($.get$shipTypes(), 51, "Search and rescue vessels");
  $.$indexSet$ax($.get$shipTypes(), 52, "Tugs");
  $.$indexSet$ax($.get$shipTypes(), 53, "Port tenders");
  $.$indexSet$ax($.get$shipTypes(), 54, "anti-pollution vessels");
  $.$indexSet$ax($.get$shipTypes(), 55, "Law enforcement vessels");
  $.$indexSet$ax($.get$shipTypes(), 56, "Spare for local vessels");
  $.$indexSet$ax($.get$shipTypes(), 57, "Spare for local vessels");
  $.$indexSet$ax($.get$shipTypes(), 58, "Medical transports");
  $.$indexSet$ax($.get$shipTypes(), 59, "Ships according to RR");
  $.$indexSet$ax($.get$shipTypes(), 60, "Passenger Ships");
  $.$indexSet$ax($.get$shipTypes(), 61, "Passenger Ships");
  $.$indexSet$ax($.get$shipTypes(), 63, "Passenger Ships");
  $.$indexSet$ax($.get$shipTypes(), 65, "Passenger Ships");
  $.$indexSet$ax($.get$shipTypes(), 67, "Passenger Ships");
  $.$indexSet$ax($.get$shipTypes(), 69, "Passenger Ships");
  $.$indexSet$ax($.get$shipTypes(), 70, "Cargo Ships");
  $.$indexSet$ax($.get$shipTypes(), 71, "Cargo Ships");
  $.$indexSet$ax($.get$shipTypes(), 72, "Cargo Ships");
  $.$indexSet$ax($.get$shipTypes(), 73, "Cargo Ships");
  $.$indexSet$ax($.get$shipTypes(), 74, "Cargo Ships");
  $.$indexSet$ax($.get$shipTypes(), 77, "Cargo Ships");
  $.$indexSet$ax($.get$shipTypes(), 79, "Cargo Ships");
  $.$indexSet$ax($.get$shipTypes(), 80, "Tanker");
  $.$indexSet$ax($.get$shipTypes(), 81, "Tanker");
  $.$indexSet$ax($.get$shipTypes(), 82, "Tanker");
  $.$indexSet$ax($.get$shipTypes(), 83, "Tanker");
  $.$indexSet$ax($.get$shipTypes(), 84, "Tanker");
  $.$indexSet$ax($.get$shipTypes(), 89, "Tanker");
  $.$indexSet$ax($.get$shipTypes(), 90, "Other Type");
  $.$indexSet$ax($.get$shipTypes(), 91, "Other Type");
  $.$indexSet$ax($.get$shipTypes(), 97, "Other Type");
  $.$indexSet$ax($.get$shipTypes(), 99, "Other Type");
  $.$indexSet$ax($.get$shipTypeColors(), 2, "#f9f9f9");
  $.$indexSet$ax($.get$shipTypeColors(), 20, "#f9f9f9");
  $.$indexSet$ax($.get$shipTypeColors(), 29, "#f9f9f9");
  $.$indexSet$ax($.get$shipTypeColors(), 30, "#f99d7b");
  $.$indexSet$ax($.get$shipTypeColors(), 31, "#4dfffe");
  $.$indexSet$ax($.get$shipTypeColors(), 32, "#4dfffe");
  $.$indexSet$ax($.get$shipTypeColors(), 33, "#f9f9f9");
  $.$indexSet$ax($.get$shipTypeColors(), 34, "white");
  $.$indexSet$ax($.get$shipTypeColors(), 35, "white");
  $.$indexSet$ax($.get$shipTypeColors(), 36, "#f900fe");
  $.$indexSet$ax($.get$shipTypeColors(), 37, "#f900fe");
  $.$indexSet$ax($.get$shipTypeColors(), 40, "#f9f9f9");
  $.$indexSet$ax($.get$shipTypeColors(), 49, "#f9f9f9");
  $.$indexSet$ax($.get$shipTypeColors(), 50, "red");
  $.$indexSet$ax($.get$shipTypeColors(), 51, "white");
  $.$indexSet$ax($.get$shipTypeColors(), 52, "#4dfffe");
  $.$indexSet$ax($.get$shipTypeColors(), 53, "#4dfffe");
  $.$indexSet$ax($.get$shipTypeColors(), 54, "white");
  $.$indexSet$ax($.get$shipTypeColors(), 55, "white");
  $.$indexSet$ax($.get$shipTypeColors(), 56, "#d2d2d2");
  $.$indexSet$ax($.get$shipTypeColors(), 57, "white");
  $.$indexSet$ax($.get$shipTypeColors(), 58, "white");
  $.$indexSet$ax($.get$shipTypeColors(), 59, "white");
  $.$indexSet$ax($.get$shipTypeColors(), 6, "#2d00fe");
  $.$indexSet$ax($.get$shipTypeColors(), 60, "#2d00fe");
  $.$indexSet$ax($.get$shipTypeColors(), 61, "#2d00fe");
  $.$indexSet$ax($.get$shipTypeColors(), 63, "#2d00fe");
  $.$indexSet$ax($.get$shipTypeColors(), 65, "#2d00fe");
  $.$indexSet$ax($.get$shipTypeColors(), 67, "#2d00fe");
  $.$indexSet$ax($.get$shipTypeColors(), 69, "#2d00fe");
  $.$indexSet$ax($.get$shipTypeColors(), 7, "#95f190");
  $.$indexSet$ax($.get$shipTypeColors(), 70, "#95f190");
  $.$indexSet$ax($.get$shipTypeColors(), 71, "#95f190");
  $.$indexSet$ax($.get$shipTypeColors(), 72, "#95f190");
  $.$indexSet$ax($.get$shipTypeColors(), 73, "#95f190");
  $.$indexSet$ax($.get$shipTypeColors(), 74, "#95f190");
  $.$indexSet$ax($.get$shipTypeColors(), 77, "#95f190");
  $.$indexSet$ax($.get$shipTypeColors(), 79, "#95f190");
  $.$indexSet$ax($.get$shipTypeColors(), 8, "#f70016");
  $.$indexSet$ax($.get$shipTypeColors(), 80, "#f70016");
  $.$indexSet$ax($.get$shipTypeColors(), 81, "#f70016");
  $.$indexSet$ax($.get$shipTypeColors(), 82, "#f70016");
  $.$indexSet$ax($.get$shipTypeColors(), 83, "#f70016");
  $.$indexSet$ax($.get$shipTypeColors(), 84, "#f70016");
  $.$indexSet$ax($.get$shipTypeColors(), 89, "#f70016");
  $.$indexSet$ax($.get$shipTypeColors(), 9, "#d2d2d2");
  $.$indexSet$ax($.get$shipTypeColors(), 90, "#d2d2d2");
  $.$indexSet$ax($.get$shipTypeColors(), 91, "#d2d2d2");
  $.$indexSet$ax($.get$shipTypeColors(), 97, "#d2d2d2");
  $.$indexSet$ax($.get$shipTypeColors(), 99, "#d2d2d2");
  $.$indexSet$ax($.get$nav_stati(), 0, "under way us. engine");
  $.$indexSet$ax($.get$nav_stati(), 1, "at anchor");
  $.$indexSet$ax($.get$nav_stati(), 2, "not under command");
  $.$indexSet$ax($.get$nav_stati(), 3, "restr. maneuverability");
  $.$indexSet$ax($.get$nav_stati(), 4, "constr. by draught");
  $.$indexSet$ax($.get$nav_stati(), 5, "moored");
  $.$indexSet$ax($.get$nav_stati(), 6, "aground");
  $.$indexSet$ax($.get$nav_stati(), 7, "engaged in fishing");
  $.$indexSet$ax($.get$nav_stati(), 8, "under way sailing");
  $.$indexSet$ax($.get$nav_stati(), 9, "future use");
  $.$indexSet$ax($.get$nav_stati(), 10, "future use");
  $.$indexSet$ax($.get$nav_stati(), 11, "future use");
  $.$indexSet$ax($.get$nav_stati(), 12, "future use");
  $.$indexSet$ax($.get$nav_stati(), 13, "future use");
  $.$indexSet$ax($.get$nav_stati(), 14, "AIS-SART (active)");
  $.$indexSet$ax($.get$nav_stati(), 15, "not defined");
  $.$indexSet$ax($.get$aton_types(), 0, "notSpecified");
  $.$indexSet$ax($.get$aton_types(), 1, "ReferencePoint");
  $.$indexSet$ax($.get$aton_types(), 2, "RACON");
  $.$indexSet$ax($.get$aton_types(), 3, "off-shoreStructure");
  $.$indexSet$ax($.get$aton_types(), 4, "futureUse");
  $.$indexSet$ax($.get$aton_types(), 5, "LightWithoutSectors");
  $.$indexSet$ax($.get$aton_types(), 6, "LightWithSectors");
  $.$indexSet$ax($.get$aton_types(), 7, "LeadingLightFront");
  $.$indexSet$ax($.get$aton_types(), 8, "LeadingLightRear");
  $.$indexSet$ax($.get$aton_types(), 9, "BeaconCardinalN");
  $.$indexSet$ax($.get$aton_types(), 10, "BeaconCardinalE");
  $.$indexSet$ax($.get$aton_types(), 11, "BeaconCardinalS");
  $.$indexSet$ax($.get$aton_types(), 12, "BeaconCardinalW");
  $.$indexSet$ax($.get$aton_types(), 13, "BeaconPorthand");
  $.$indexSet$ax($.get$aton_types(), 14, "BeaconStarboardhand");
  $.$indexSet$ax($.get$aton_types(), 15, "BeaconPreferredChannelPortHand");
  $.$indexSet$ax($.get$aton_types(), 16, "BeaconPreferredChannelStarboardHand");
  $.$indexSet$ax($.get$aton_types(), 17, "BeaconIsolatedDanger");
  $.$indexSet$ax($.get$aton_types(), 18, "BeacoSafeWater");
  $.$indexSet$ax($.get$aton_types(), 19, "BeaconSpecialMark");
  $.$indexSet$ax($.get$aton_types(), 20, "CardinalMarkN");
  $.$indexSet$ax($.get$aton_types(), 21, "CardinalMarkE");
  $.$indexSet$ax($.get$aton_types(), 22, "CardinalMarkS");
  $.$indexSet$ax($.get$aton_types(), 23, "CardinalMarkW");
  $.$indexSet$ax($.get$aton_types(), 24, "PortHandMark");
  $.$indexSet$ax($.get$aton_types(), 25, "StarboardHandMark");
  $.$indexSet$ax($.get$aton_types(), 26, "PreferredChannelPortHand");
  $.$indexSet$ax($.get$aton_types(), 27, "PreferredChannelStarboardHand");
  $.$indexSet$ax($.get$aton_types(), 28, "IsolatedDanger");
  $.$indexSet$ax($.get$aton_types(), 29, "SafeWater");
  $.$indexSet$ax($.get$aton_types(), 30, "SpecialMark");
  $.$indexSet$ax($.get$aton_types(), 31, "LightVessel/LANBY/Rigs");
};

$.OpenStreetMap$ = function(elementid, mapOptions, height, width) {
  var t1 = new $.OpenStreetMap(null, null, null, null, null, null, null, null, null, null, null);
...
$.Primitives_applyFunction = function($function, positionalArguments, namedArguments) {
  ...
  if (namedArguments != null && t1.get$isEmpty(namedArguments) !== true) {
    listOfNamedArguments = $.List_List$from(t1.get$keys(namedArguments), true, $.String);
...
$.CONSTANT8 = new $.EventStreamProvider("close");
...
$.CONSTANT9 = new $.EventStreamProvider("open");
$.CONSTANT7 = new $.EventStreamProvider("message");
...
$.closePopup$0$x = function(receiver) {
  return $.getInterceptor$x(receiver).closePopup$0(receiver);
};
...
$.get$_get_data$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$_get_data(receiver);
};
...
$.get$console$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$console(receiver);
};
...
$.$defineNativeClass("MessageEvent", {"": "_get_data:data=",
  get$data: function(receiver) {
    return $.convertNativeToDart_SerializedScriptValue($.get$_get_data$x(receiver));
  }
});
...
$.$defineNativeClass("DOMWindow", {"": "innerHeight=,innerWidth=,_get_parent:parent=",
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "get$L,_key$1,_put$1,call$0,call$1,call$2,call$3,call$4,eval$1,get$sb,push$1,then$1,_next$1,addTo$1,addTo$2,get$Map,get$_id,get$Icon,get$_map,get$_set,get$_tag,listen$1,lookup$1,set$_map,toJson$0,_isFree$1,get$Point,get$Popup,get$cause,loadMap$0,process$0,set$_zoom,_writeOn$1,addLayer$1,callSync$1,get$LatLng,get$Marker,get$_popup,get$_state,get$_table,moveNext$0,register$2,set$_popup,set$_state,_callback$2,_dispatch$1,_sendData$1,_sendDone$0,_setError$1,_setValue$2,exitScope$0,get$Control,get$_portId,get$current,openPopup$1,set$_handle,_sendError$1,_sendValue$1,catchError$1,enterScope$0,get$Polyline,get$imageURL,get$isWorker,get$sendPort,toSendPort$0,unregister$1,_setGlobals$0,clearLayers$0,get$TileLayer,get$_callback,get$_duration,get$_registry,get$_workerId,get$dimension,removeLayer$1,addListeners$1,get$LayerGroup,get$_elementid,get$_entrySize,get$_hashTable,get$_isolateId,get$initialLat,get$initialLon,get$stackTrace,runIteration$0,throwDelayed$0,toBBoxString$0,_checkReplyTo$1,get$_mapFeature,get$initialZoom,set$_mapFeature,_checkCapacity$0,get$CircleMarker,get$_receivePort,get$topEventLoop,get$MousePosition,get$_elementCount,get$_nextListener,get$_scopeIndices,get$nextIsolateId,set$_nextListener,set$nextIsolateId,get$currentContext,get$inMilliseconds,get$moveendHandler,clearFeatureLayer$0,get$animatedPolygon,_checkModification$1,_liblib0$_setValue$1,_liblib3$_callback$1,get$_featureLayerGroup,get$_hasUnhandledError,get$_modificationCount,get$_resultOrListeners,set$_featureLayerGroup,get$millisecondsSinceEpoch".split(","), longNames = "L,_key,_put,call,call,call,call,call,eval,sb,push,then,_next,addTo,addTo,Map,_id,Icon,_map,_set,_tag,listen,lookup,_map=,toJson,_isFree,Point,Popup,cause,loadMap,process,_zoom=,_writeOn,addLayer,callSync,LatLng,Marker,_popup,_state,_table,moveNext,register,_popup=,_state=,_callback,_dispatch,_sendData,_sendDone,_setError,_setValue,exitScope,Control,_portId,current,openPopup,_handle=,_sendError,_sendValue,catchError,enterScope,Polyline,imageURL,isWorker,sendPort,toSendPort,unregister,_setGlobals,clearLayers,TileLayer,_callback,_duration,_registry,_workerId,dimension,removeLayer,addListeners,LayerGroup,_elementid,_entrySize,_hashTable,_isolateId,initialLat,initialLon,stackTrace,runIteration,throwDelayed,toBBoxString,_checkReplyTo,_mapFeature,initialZoom,_mapFeature=,_checkCapacity,CircleMarker,_receivePort,topEventLoop,MousePosition,_elementCount,_nextListener,_scopeIndices,nextIsolateId,_nextListener=,nextIsolateId=,currentContext,inMilliseconds,moveendHandler,clearFeatureLayer,animatedPolygon,_checkModification,_setValue,_callback,_featureLayerGroup,_hasUnhandledError,_modificationCount,_resultOrListeners,_featureLayerGroup=,millisecondsSinceEpoch".split(",");
